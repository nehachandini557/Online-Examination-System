	...
	<div id="container">
		...
		<div id="content">
			<div id="main1">
				<form action="HomeController">
					<br> <h3>Name : </h3><input type="text" id="name" name="name"
						placeholder=" Enter FacultyName" required><br> <br>
			...
			<div id="navigation">
				...
				<a href="HomeController?action=faculty" class="btn btn-info btn-block"
					role="button" value="faculty">Create Faculty</a><br> <br>
